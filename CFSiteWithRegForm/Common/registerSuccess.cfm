<!---
	Filename 		: 	registerSuccess.cfm
 	Functionality	:	Alerts user with successful validation message
 						Provides links to login Page
	Creation Date	:	 ‎July ‎4, ‎2017, ‏‎2:39:48 PM
	...
	<head>
		...
		<body>
		  	<div class="checkmark">
				...
				<a alt="loginPageLink" href="../user/login.cfm"><p>Click here to Login</p></a>
			</div>
	</body>
</html>